...
from config import *
from show_pointcloud import draw_registration_result
...
if __name__ == '__main__':
    ...
    config_path = './GPINets-master/snapshot/GPINets_3DMatch_xxxxx/config.json'
    #print(config_path)
    ...
    miss = model.load_state_dict(torch.load(
        './GPINets-master/snapshot/GPINets_3DMatch_xxxx/models/model_best.pkl'),
        strict=False)  #best
    print(miss)
    # print(i)
    model.eval()
