...
def eval_3DMatch(model, config, args):
    dset = ThreeDLOMatchTest(root='./PointDSC/data/3DMatch',
                             descriptor='fcgf',
...
if __name__ == '__main__':
    ...
    config_path = f'./GPINets-master/snapshot/GPINets_3DMatch_xxxx/config.json'
    ...
    from models.GPINets import GPINets
    ...
    miss = model.load_state_dict(
        torch.load(f'./GPINets-master/snapshot/GPINets_3DMatch_xxxx/models/model_best.pkl'), strict=False)
    print(miss)
    model.eval()
