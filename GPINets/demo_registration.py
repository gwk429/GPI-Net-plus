...
from old_model.PGNet import PGNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--chosen_snapshot', default='PGNet_3DMatch_12181640', type=str, help='snapshot dir')
    parser.add_argument('--pcd1', default='F:/gwk/PG-Net-master/demo_data/cloud_bin_0.ply', type=str)
    parser.add_argument('--pcd2', default='F:/gwk/PG-Net-master/demo_data/cloud_bin_1.ply', type=str)
    ...
    config_path = 'F:/gwk/PG-Net-master/snapshot/PGNet_3DMatch_12181640/config.json'
    ...
    miss = model.load_state_dict(
        torch.load(f'F:/gwk/PG-Net-master/snapshot/PGNet_3DMatch_12181640/models/model_best.pkl',
